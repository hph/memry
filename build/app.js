...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_datamaps__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__states_json__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__states_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__states_json__);
...
const map = new __WEBPACK_IMPORTED_MODULE_0_datamaps___default.a({
  element: container,
  scope: 'usa',
  geographyConfig: {
    popupOnHover: false,
...
function onEnter (event) {
  if (event.keyCode === 13) {
    ...
    event.target.value = '';
    const state = __WEBPACK_IMPORTED_MODULE_2__states_json___default.a.find(state => state.name === value);
